    ...
    function render(){   
		...
		if ($this->field['font-family'] === true):
	        ...
	        echo '<div id="'.$this->field['id'].'" class="redux-typography-container" data-id="'.$this->field['id'].'" data-units="'.$unit.'">';
              ...
              echo '<div class="select_wrapper typography-family" style="width: 180px; margin-right: 20px;">';
              echo '<select data-placeholder="'.__('Yazı Tipi','redux-framework').'" class="redux-typography redux-typography-family '.$this->field['class'].'" id="'.$this->field['id'].'-family" data-id="'.$this->field['id'].'" data-value="'.$fontFamily[0].'">';
              ...
              if ( $this->field['google'] == true && !empty( $this->args['google_api_key'] ) ) {
                echo '<optgroup label="'.__('Standart Fontlar', 'redux-framework').'">';  
              }
            ...
            if ($this->field['subsets'] === true && $this->field['google'] === true):
                ...
                echo '<select data-placeholder="'.__('Alt Setler','redux-framework').'" class="redux-typography redux-typography-subsets'.$this->field['class'].'" original-title="'.__('Font script','redux-framework').'"  id="'.$this->field['id'].'-subsets" name="'.$this->args['opt_name'].'['.$this->field['id'].'][subsets]" data-value="'.$this->value['subsets'].'" data-id="'.$this->field['id'].'" >';
