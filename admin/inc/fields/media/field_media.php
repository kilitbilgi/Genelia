...
if( !class_exists( 'ReduxFramework_media' ) ) {
    ...
    class ReduxFramework_media extends ReduxFramework {
        ...
        public function render() {
            ...
            $placeholder = isset($this->field['placeholder']) ? $this->field['placeholder'] : __('Hiçbir kaynak seçilmedi','redux-framework');
            ...
            echo '<span class="button media_upload_button" id="' . $this->field['id'] . '-media">' . __( 'Yükle', 'redux-framework' ) . '</span>';
            
            $hide = '';
            if( empty( $this->value['url'] ) || $this->value['url'] == '' )
                $hide =' hide';

            echo '<span class="button remove-image' . $hide . '" id="reset_' . $this->field['id'] . '" rel="' . $this->field['id'] . '">' . __( 'Sil', 'redux-framework' ) . '</span>';
